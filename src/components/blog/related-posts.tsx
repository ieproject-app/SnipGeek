...
export function RelatedPosts({
    ...
    const renderCard = (item: any) => {
        ...
        return (
            <div key={item.slug} className="group relative flex flex-col overflow-hidden rounded-xl border bg-card/50 shadow-sm transition-all hover:shadow-lg hover:-translate-y-2 h-full">
                ...
                <div className="px-6 py-4 border-t bg-muted/5">
                    <div className="flex flex-wrap gap-2">
                        {item.frontmatter.tags && item.frontmatter.tags.slice(0, 2).map((tag: string) => (
