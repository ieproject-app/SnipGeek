...
> = {
  neutral: {
    surface: "border-border/50 bg-card/80",
    surfaceActive: "hover:border-accent/30 hover:bg-card/90",
  ...
  accent: {
    ...
    surfaceActive: "hover:border-accent/60 hover:bg-accent/20",
  ...
  warn: {
    ...
    surfaceActive: "hover:border-amber-500/60 hover:bg-amber-500/15",
    iconWrap: "bg-amber-500/20 text-amber-600 dark:text-amber-400",
    dot: "bg-amber-500",
  ...
  ok: {
    ...
    surfaceActive: "hover:border-emerald-500/60 hover:bg-emerald-500/15",
  ...
  danger: {
    ...
    surfaceActive: "hover:border-destructive/60 hover:bg-destructive/20",
