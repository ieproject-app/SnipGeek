              ...
              >
                ...
                >
                  <div className="relative aspect-[16/10] overflow-hidden rounded-t-xl">
                    ...
                    <div
                      className={cn(
                        "absolute bottom-0 left-0 right-0 h-0.75 opacity-0 transition-opacity duration-500 group-hover/card:opacity-100",
                        multicolor.accentBar,
                      )}
                    />
                  ...
                  <div className="p-4 flex flex-col gap-2">
                    ...
                    <h3
                      className={cn(
                        "font-display text-lg font-bold leading-snug text-primary transition-colors duration-300",
                  ...
                  >
                    <article className="space-y-5">
                      ...
                      >
                        <div
                          className={cn(
                            "absolute bottom-0 left-0 right-0 h-0.75 z-30 transition-opacity duration-500 opacity-0 group-hover:opacity-100",
                            multicolor.accentBar,
                          )}
                        />
                        <div
