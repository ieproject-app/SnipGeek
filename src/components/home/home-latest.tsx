      ...
      >
        <Link href={`${linkPrefix}/blog/${post.slug}`} className="block">
          ...
          >
            ...
            <div
              className={cn(
                "absolute bottom-0 left-0 right-0 h-0.75 opacity-0 transition-opacity duration-500 group-hover:opacity-100",
          ...
          <h3
            className={cn(
              "font-display text-lg sm:text-base font-semibold tracking-tight text-primary transition-colors leading-tight mb-2",
