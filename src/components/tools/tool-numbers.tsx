...
export function ToolNumbers({
    ...
    const hook = useToolNumbers(initialDateKey);
    const { hasResults, isAdminUser } = hook;
    const toolMeta = dictionary.tools.tool_list.number_generator;
    const enableManualAdLayout = process.env.NODE_ENV === 'production';
    ...
    const toolContent = (
        <div className="mx-auto w-full max-w-4xl space-y-10">
            ...
            <AdSenseUnit slot="8443199432" size="belowContent" className="mx-auto my-0 max-w-3xl" />
        </div>
    );
