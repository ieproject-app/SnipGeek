...
<Steps>
  ...
  ![Alias snipgeek terminal output](https://res.cloudinary.com/snipgeek/image/upload/q_auto/f_auto/v1781144763/snipgeek/images/_notes/npm-run-shortcut/npm-snipgeek.webp)
