...
heroImage: "https://res.cloudinary.com/snipgeek/image/upload/q_auto/f_auto/v1781144765/snipgeekhttps://res.cloudinary.com/snipgeek/image/upload/q_auto/f_auto/v1781144765/snipgeek/images/_notes/localhost-ip/localhost-ip-error.png"
...
![Screenshot resulting from an unauthorized Firebase Auth Domain](https://res.cloudinary.com/snipgeek/image/upload/q_auto/f_auto/v1781144765/snipgeekhttps://res.cloudinary.com/snipgeek/image/upload/q_auto/f_auto/v1781144765/snipgeek/images/_notes/localhost-ip/localhost-ip-error.png)
...
<Steps>
    ...
    <Step>Enter the precise localhost IP address causing the glitch (e.g., `172.16.0.2`), bearing in mind to enter it **completely bare—without any `http://` prefixes or port numbers**. ![Adding IP to Firebase Authorized Domains](https://res.cloudinary.com/snipgeek/image/upload/q_auto/f_auto/v1781144767/snipgeekhttps://res.cloudinary.com/snipgeek/image/upload/q_auto/f_auto/v1781144767/snipgeek/images/_notes/localhost-ip/firebase-auth.webp)</Step>
