...
![Screenshot Error Domain Belum Didaftarkan Firebase Auth](https://res.cloudinary.com/snipgeek/image/upload/q_auto/f_auto/v1781144765/snipgeek/images/_notes/localhost-ip/localhost-ip-error.png)
...
<Steps>
    ...
    <Step>Masukkan alamat IP *localhost* Anda yang bermasalah (contoh: `172.16.0.2`) dan ingat, **tanpa memuat `http://` atau port**. ![Input IP ke Authorized Domains Firebase](https://res.cloudinary.com/snipgeek/image/upload/q_auto/f_auto/v1781144767/snipgeek/images/_notes/localhost-ip/firebase-auth.webp)</Step>
