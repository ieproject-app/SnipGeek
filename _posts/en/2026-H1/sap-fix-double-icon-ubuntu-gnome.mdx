...
<Steps>
  ...
  <Step>
    ...
    ![Terminal showing xprop output and nano editing the .desktop file](https://res.cloudinary.com/snipgeek/image/upload/q_auto/f_auto/v1781144636/snipgeek/images/_posts/linux/sap-fix-double-icon/terminal-view.webp)
