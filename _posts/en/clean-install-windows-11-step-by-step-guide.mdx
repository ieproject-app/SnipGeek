...
tags: ["Windows 11", "Clean Install", "Tutorial", "Operating System", "Guide"]
...
1. **Prepare a Windows 11 Bootable USB:** This will be our installation tool. If you haven't made one yet, follow our simple guide here.
   - **Read more:** [Complete Guide: How to Create Windows 11 Bootable USB with Rufus](/blog/how-to-create-windows-11-bootable-usb-with-rufus)
...
<ImageGrid columns={2}>
![Initial Partition List](/images/_posts/windows11/install-windows-11/virtualbox/6.1.webp "List of all partitions before deletion.")
![Deleting Partitions](/images/_posts/windows11/install-windows-11/virtualbox/6.3%20Tambahan.webp "Deleting system partitions one by one.")
</ImageGrid>

Once you have only one block of **"Unallocated Space"**, select it and click **Next**.

![Unallocated Space](/images/_posts/windows11/install-windows-11/virtualbox/6.2.webp "Screen after partitions are deleted, leaving Unallocated Space.")
</Step>
